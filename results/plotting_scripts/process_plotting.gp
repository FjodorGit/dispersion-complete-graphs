...
# average process capacity_1
set yr [0:10000]
set title 'Average process of unhappy particles n=1000000 and M=505000' 
set arrow from 0,5689  to 5001, 5689 nohead dashtype 1 lc rgb "#FF7800" lw 4 front
set output '/home/fjk/Uni/Bachelorarbeit/Arbeit/bilder/unhappy_capacity_1/average_process.tex'
plot 1/0 t "threshold" dashtype 1 lc rgb "#FF7800" lw 4, \
"../average_process/fully_connected/capacity_1/average_process_calculated.dat" ls 4 notitle with lines
unset arrow

# average process capacity_2
set yr [0:10000]
set title 'Average process of unhappy particles n=1000000 and M=1005000 with capacity 2' 
set output '/home/fjk/Uni/Bachelorarbeit/Arbeit/bilder/cap2/average_process.tex'
plot "../average_process/fully_connected/capacity_2/average_process_calculated.dat" ls 4 notitle with lines
